...
#define VERTEX_SIZE (3 + 2 + 1) //vertex + texture coord + light
...
VoxelRenderer::VoxelRenderer(size_t _capacity) : capacity(_capacity) {
...
Mesh* VoxelRenderer::render(Chunk* chunk, const Chunk** chunks, bool ao) {
